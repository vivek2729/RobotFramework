...
Rachel_Maddow_Automation
    ...
    SeleniumLibrary.Open Browser    https://www.youtube.com/results?search_query=rachel+maddow&sp=CAISBAgDEAE%253D    chrome
...
Extracting_Details_From_URL
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Date= '${Date}' where id=${Count3}
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Full_View_Count ='${Full_View_Count}' where id=${Count3}
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Short_View_Count= '${Short_View_Count}' where id='${Count3}'
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Total_Likes ='${Total_Likes}' where id=${Count3}
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Total_Dislikes ='${Total_Dis_Likes}' where id=${Count3}
    ${Total_Subscribers}=    Get Text    css=#owner-sub-count
    ${Total_Subscribers}=    String.Replace String    ${Total_Subscribers}    '    ''
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Total_Subscribers= '${Total_Subscribers}' where id=${Count3}
    Sleep    3s
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Channel_Name= '${Channel_Name}' where id=${Count3}
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Category= '${Category}' where id=${Count3}
    Sleep    3s
    ${Description}=    Get Text    css=div#description>yt-formatted-string
    ${Description}=    String.Replace String    ${Description}    '    ''
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Channel_Description= '${Description}' where id=${Count3}
...
Extracting_Details_From_Main_Page
    ...
    DatabaseLibrary.Execute Sql String    INSERT INTO nbcu_pilot.Youtube_Rachel_Maddow (`Title`) VALUES ('${Title}')
    Sleep    5s
    ${list}=    DatabaseLibrary.Query    select max(id) from nbcu_pilot.Youtube_Rachel_Maddow;
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Total_View= '${Total_View}' where id=${Count3}
    Sleep    5s
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Video_Rendered_Before= '${Video_Rendered_Before}' where id=${Count3}
    Sleep    5s
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set Duration= '${Duration}' where id=${Count3}
    Sleep    5s
    ...
    DatabaseLibrary.Execute Sql String    update nbcu_pilot.Youtube_Rachel_Maddow set URL= '${URL}' where id=${Count3}
